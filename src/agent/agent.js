...
const graph = new StateGraph(MessagesAnnotation)
    ...
    .addNode("chat", async (state, config) => {
        const response = await model.invoke(state.messages, { tools: [tools.searchProduct, tools.addProductToCart, tools.getUserCart, tools.getUserWishlist, tools.getUserRecentOrders, tools.addProductToWishlist,tools.getSomeProducts] });
